...
- [x] Run all Phase 1–2 model variants on all 4 tasks: scalar EP, Clifford-EP Cl(3,0), Clifford-EP CGA, scalar BP, Clifford-BP Cl(3,0), EGNN (task 2 only)
...
- [x] **Report the 5×4 matrix** with key metric per domain + equivariance violation; annotate which variant is best per domain; this is the primary Phase 4 output figure
